...
export const postEvent = async (req, res) => {
    ...
    try {
        await pool.query("INSERT INTO events (title, description, location, date, time, user_id) VALUES ($1, $2, $3, $4, $5, $6)", [title, description, location, date, time, user_id])
...
export const updateUser = async (req, res) => {
    ...
    try {
        ...
        await pool.query("UPDATE events SET title = $1, description = $2, location = $3, date = $4, time = $5 WHERE id_event = $6", [title, description, location, date, time, id_event])
